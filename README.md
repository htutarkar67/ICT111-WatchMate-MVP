...
The team intends to develop a web-based movie recommendation platform called MovieMatch. The platform will enable users to search for movies, choose their preferred genres, create and manage watchlists, rate films, and receive personalized recommendations. Its goal is to simplify movie discovery and minimize the time users spend looking for suitable content.
...
We carried out our customer discovery process by obtaining feedback from university students, movie enthusiasts, and online streaming platform users. The feedback collected helped us gain a deeper understanding of their needs, preferences, and the challenges they face when searching for suitable movie recommendations.
...
The team has decided to maintain the current problem focus and proceed with the development of the WatchMate Movie Recommendation System based on validated customer feedback and research results.
...
Movie viewers who experience challenges in discovering films that fit their interests and often spend a significant amount of time deciding what to watch because of the large number of available movie choices.
.
...
The documentation and planning carried out during Lab 06 serve as the foundation for the development of the final WatchMate prototype.

### UI/UX Translation
The finished wireframes, including the homepage, AI chatbot, search results, movie details, watchlist, chat history, and admin dashboard, provide a structured layout for the final user interface. These designs assist the React frontend development process while maintaining a consistent and user-friendly experience.
...
The prototype satisfies all required functional requirements and demonstrates the key capabilities of an AI-powered movie recommendation system, including AI chatbot interaction, personalized recommendations, movie search functionality, movie detail viewing, watchlist management, recommendation history tracking, and administrative features.
