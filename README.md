...
**Reason:**  
Our prototype is an interactive frontend application designed to simulate the AI movie recommendation workflow. It enables users to complete the main tasks and provides an effective way to evaluate usability before developing the full system.
