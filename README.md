...
We have conducted our customer discovery activities and collected feedback from university students, movie enthusiasts, and streaming platform users.
...
The frontend will offer an interactive interface where users can explore trending movies, search for titles, chat with the AI assistant, manage their watchlist, and review previous conversations.The backend will handle user requests, communicate with the AI chatbot and TMDB API, and manage user data stored in SQLite. This architecture provides a simple yet scalable solution that supports the project's MVP while allowing future enhancements.
...
- **Version:** v1
- **Screenshots:** [screenshots/project-dashboard.png](https://github.com/htutarkar67/ICT111-WatchMate-MVP/blob/a20adb7f7e495e33ac4876cae36e12b8747418cd/screenshots/project-dashboard.md)
